...
public class TodayFragment extends Fragment {
    ...
    private RecyclerView recyclerView_liveClass_today;
    private ArrayList<LiveClassModel> liveClassModel = new ArrayList<>();
    private LiveClassAdapter liveClassAdapter;

    public TodayFragment(ArrayList<LiveClassModel> liveClassModel) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        recyclerView_liveClass_today = view.findViewById(R.id.recyclerView_liveClass_today);
        ...
        if (liveClassAdapter.getItemCount() == 0) {
            ...
            recyclerView_liveClass_today.setAdapter(liveClassAdapter);
        }
